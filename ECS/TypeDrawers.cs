...
internal static class TypeDrawers
{
    ...
    internal static void Register()
    {
        ...
        // --- Godot types
        EcGui.Setup.RegisterTypeDrawer<Godot.Vector2>   (new Vector2Drawer());
        EcGui.Setup.RegisterTypeDrawer<Godot.Vector3>   (new Vector3Drawer());
        EcGui.Setup.RegisterTypeDrawer<Godot.Vector4>   (new Vector4Drawer());
        EcGui.Setup.RegisterTypeDrawer<Godot.Color>     (new ColorDrawer());
    }
}
